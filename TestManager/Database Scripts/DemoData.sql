insert into Companies (Number, StationsCompleted) Values (1, 0);
insert into Companies (Number, StationsCompleted) Values (2, 0);
insert into Companies (Number, StationsCompleted) Values (3, 0);
insert into Companies (Number, StationsCompleted) Values (4, 0);
insert into Companies (Number, StationsCompleted) Values (5, 0);
insert into Companies (Number, StationsCompleted) Values (6, 0);
insert into Companies (Number, StationsCompleted) Values (7, 0);
insert into Companies (Number, StationsCompleted) Values (8, 0);
insert into Companies (Number, StationsCompleted) Values (9, 0);
